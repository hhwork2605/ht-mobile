...
namespace HtMobile.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260618074935_AddCouponSupport")]
    partial class AddCouponSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HtMobile.Domain.Entities.Customers.Customer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HtMobile.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HtMobile.Domain.Entities.Sales.Order", b =>
                {
                    b.HasOne("HtMobile.Domain.Entities.Customers.Customer", "Customer")
                        .WithMany("Orders")
